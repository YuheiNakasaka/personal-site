...
const FleetArtEditorAboutPage: BlitzPage = () => {
  return (
    <>
      <Head>
      ...
      <section className="container">
        <div className="section">
          ...
          <p>
            In addition to the features of the original version of the editing editor, Fleet Art
            Editor has a history feature.
          </p>

          <p>This allows you to save your editing history for the past few projects.</p>

          <p>It is also possible to recreate from the saved history.</p>

          <p>
            The created fleet art can be saved directly to the camera roll. Of course, you can also
            share it to other SNS.
          </p>
          ...
          <div className="dl-icons">
            <div className="dl-icon">
              <a href="https://apps.apple.com/bg/app/id1584350360" target="_blank" rel="noreferrer">
                <Image
                  className="apple"
                  alt="apple btn"
                  size="4xl"
...
FleetArtEditorAboutPage.authenticate = false
FleetArtEditorAboutPage.getLayout = (page) => <Layout>{page}</Layout>
