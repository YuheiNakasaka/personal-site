...
const FleetArtEditorPrivacyPolicyPage: BlitzPage = () => {
  return (
    <>
      <Head>
      ...
      <section className="container">
        <div className="section">
          ...
          <p>
            YuheiNakasaka built the Fleet Art Editor app as an Ad Supported app. This SERVICE is
            provided by YuheiNakasaka at no cost and is intended for use as is.
          </p>
          <p>
          ...
          <p>
            ...
            Conditions, which is accessible at Fleet Art Editor unless otherwise defined in this
            Privacy Policy.
          </p>
        </div>
        <div className="section">
        ...
        <div className="section">
          ...
          <p>This policy is effective as of 2021-09-05</p>
        </div>
        <div className="section">
          <p>
          ...
          <p>
            ...
            contact me at mochiogaile@gmail.com.
          </p>
          <p>
...
FleetArtEditorPrivacyPolicyPage.authenticate = false
FleetArtEditorPrivacyPolicyPage.getLayout = (page) => <Layout>{page}</Layout>

export default FleetArtEditorPrivacyPolicyPage
