...
const MigawariPrivacyPolicyPage: BlitzPage = () => {
  return (
    <>
      <Head>
      ...
      <section className="container">
        <div className="section">
          ...
          <p>
            YuheiNakasaka built the Migawarii app as an Ad Supported app. This SERVICE is provided
            by YuheiNakasaka at no cost and is intended for use as is.
          </p>
          <p>
          ...
          <p>
            ...
            Conditions, which is accessible at Migawarii unless otherwise defined in this Privacy
            Policy.
          </p>
        </div>
        <div className="section">
...
MigawariPrivacyPolicyPage.authenticate = false
MigawariPrivacyPolicyPage.getLayout = (page) => <Layout>{page}</Layout>

export default MigawariPrivacyPolicyPage
