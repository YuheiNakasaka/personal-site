...
const MigawariPrivacyPolicyPage: NextPage = () => {
  return (
    <>
      <Head>
      ...
      <section className="container">
        <div className="section">
          <div className="section">
            <p>日本語版はこちらになります。</p>
            <a
              href="/migawari/migawari_privacy_policy_ja"
              target="_blank"
              rel="noreferrer"
            >
              ・プライバシーポリシー
          ...
          <p>
            YuheiNakasaka built the Migawarii app as an Ad Supported app. This
            SERVICE is provided by YuheiNakasaka at no cost and is intended for
            use as is.
          </p>
          <p>
          ...
          <p>
            ...
            our Terms and Conditions, which is accessible at Migawarii unless
