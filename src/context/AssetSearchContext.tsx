...
interface AssetSearchContextProviderProps {
  children: React.ReactNode;
}

export const AssetSearchContextProvider: React.FC<
  AssetSearchContextProviderProps
> = ({ children }) => {
  ...
  return (
    <AssetSearchContext.Provider value={newContext}>
      {children}
